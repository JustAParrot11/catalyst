        ...
        "properties": {
            ...
            "conviction": {
                ...
                "description": (
                    ...
                    "trading is correct. THAT IS A DIFFERENT QUANTITY "
                    "from a directional frequency and the two are not "
                    "comparable: being sure there is nothing here is "
                    "cheap, while being right about a direction 57% of "
                    "the time is the best this system has ever measured "
                    "out of sample. So do not read a high number on a "
                    "no_trade as a stronger answer than a modest one on "
                    "a direction, and do not reach for no_trade because "
                    "it is the branch where you can score highly.\n"
