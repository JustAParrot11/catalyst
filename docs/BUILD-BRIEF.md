...
| Runtime API budget | **you propose it and justify it** — see below |
| Live trading | **paper only** until proven |

**The $200 is for building. It is not a monthly allowance.**

You decide the runtime budget and justify it. Here is the arithmetic you
are working against — costs are near-fixed in dollars, so on $1,000 they
are punishing:
